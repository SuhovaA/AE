...
#     ABSTRACT_FROM => q[lib/AE/Simple.pm]
#     AUTHOR => [q[Nastena <nastena@>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[AE::Simple]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/AE/Simple.pm]
...
INST_LIBDIR      = $(INST_LIB)/AE
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/AE
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Nastena <nastena@>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: AE-Simple' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "AE-Simple",' >> META_new.json
